...
import { userLogin } from "../state/features/user/userSlice";
  ...
  return (
    <div className={classNames(styles.login)}>
      ...
      <div className="container">
        {/* Appbar */}
        <Appbar customClasses={classNames(styles.login__header)} logo />
        <main className="login__main">
          <form
            className={classNames(styles.login__form, "form")}
      ...
      {/* Footer */}
      <Footer mini customClasses={styles.login__footer} />
    </div>
  );
}
